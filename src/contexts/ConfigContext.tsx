  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      try {
        ...
        if (parsed.model === 'gemini-1.5-pro' || parsed.model === 'gemini-3.0-pro' || parsed.model === 'gemini-2.0-pro-exp-02-05') parsed.model = 'gemini-3.1-pro-preview';
        
        const validModels = ['gemini-3-flash-preview', 'gemini-3.1-pro-preview', 'gemini-1.5-flash'];
