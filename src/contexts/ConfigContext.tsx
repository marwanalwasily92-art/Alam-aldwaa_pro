  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      try {
        ...
        if (parsed.model === 'gemini-3-flash-preview' || parsed.model === 'gemini-1.5-flash' || parsed.model === 'gemini-2.0-flash' || parsed.model === 'gemini-2.0-flash-exp') parsed.model = 'gemini-3-flash-preview';
        if (parsed.model === 'gemini-3.1-pro-preview' || parsed.model === 'gemini-1.5-pro' || parsed.model === 'gemini-3.0-pro' || parsed.model === 'gemini-2.0-pro-exp-02-05') parsed.model = 'gemini-3.1-pro-preview';
